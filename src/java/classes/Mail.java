...
public class Mail extends Objet {
    ...
    public void send() {
        try {
            ...
            email.setAuthenticator(new DefaultAuthenticator("noreply@emploiservices.net", "paradize"));
            email.addTo(this.destinataireEmail, this.destinataireNom);
            email.setFrom("noreply@emploiservices.net", Datas.TITRESITE);
    ...
    this.contenu+="<br/>";
    this.contenu+="<p>Votre annonce a une durée de vie de 6 mois à partir du moment ou elle est en tête de liste.</p>";
    this.contenu+="<p>Pour remmetre votre annonce en haut de la liste allez sur <a href=\""+Datas.URLROOT+"/mes-annonces.html\" title=\"Vos annonces\">"+Datas.URLROOT+"/mes-annnonces.html</a> et cliquez sur \"METTRE EN HAUT DE LA LISTE\".</p>";
    this.contenu+="<p></p>";
    this.contenu+="<div><a href=\""+Datas.URLROOT+"\">"+Datas.URLROOT+"</a>";
    this.contenu+="<br/>";
    this.contenu+="<br/>";
    ...
    this.contenu+="<br/>";
    this.contenu+="<hr/>";
    this.contenu+="<div class=\"info\">U abus a été signalé.</div>";
    this.contenu+="<br/>";
    ...
    public void initMailMessage1(String pseudoMembreExpediteur, String pseudoMembreDestinataire, String titreMsg, long idMessage) {
        this.contenu="<html";
        this.contenu+="<head>";
        this.contenu+="<style type=\"text/css\">";
        this.contenu+="body {";
    ...
    this.contenu+="<br/>";
    this.contenu+="<div class=\"info\">Titre du message : "+titreMsg+".</div>";
    this.contenu+="<br/>";
    ...
    public void initMailMessage2(String pseudoMembreExpediteur, String pseudoMembreDestinataire, String titreMsg, long idMessage) {
        this.contenu="<html";
        this.contenu+="<head>";
        this.contenu+="<style type=\"text/css\">";
        this.contenu+="body {";
    ...
    public void initMailLimite(String pseudo, String titre) {
        this.contenu="<html";
        this.contenu+="<head>";
        this.contenu+="<style type=\"text/css\">";
        this.contenu+="body {";
	...
	this.contenu+="font-weight: 600;";
        ...
        this.contenu+="<hr/>";
        this.contenu+="<br/>";
        this.contenu+="<div class=\"info\">Cher(e) "+pseudo+",</div>";
        this.contenu+="<p>Cela fait "+Datas.getNBMOISLIMITE()+" mois que votre annonce :\""+titre+"\" est publié sur notre site : "+Datas.URLROOT+".</p>";
        this.contenu+="<p>La durée de vie d'une annonce sur notre site est de "+Datas.getNBMOISEFFACE()+" mois.</p>";
        this.contenu+="<p>Si vous ne voulez pas que votre annonce soit éffacée vous pouvez la \"réactualiser\".</p>";
        this.contenu+="<p>Pour se faire allez ici <a href=\""+Datas.URLROOT+"/mes-annonces.html\" title=\"Réactualiser mon annonce\">"+Datas.URLROOT+"/mes-annonces.html</a> et cliquez sur \"METTRE EN HAUT DE LA LISTE\".</p>";
        this.contenu+="<p>Votre annonce sera alors publiée pendant "+Datas.getNBMOISEFFACE()+" mois.</p>";
        this.contenu+="<p>Vous pouvez répeter l'opération autant de fois que vous le désirez.</p>";
        this.contenu+="<br/>";
        this.contenu+="<div class=\"info\">Ceci est un mail automatique, inutile d'y répondre.</div>";
        this.contenu+="<br/>";
        this.contenu+="</body>";
