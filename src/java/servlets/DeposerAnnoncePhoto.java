 ...
 * @author pj
 */
public class DeposerAnnoncePhoto extends HttpServlet {
        ...
        try {
            ...
            if(membre.getId()==0)
                ...
                if(session.getAttribute("idAnnonce")==null)
                    ...
                    Photo photo=new Photo(idAnnonce, membre);
                    photo.initInfosAnnonce();
                    if(photo.getIdAnnonce()==0)
                        request.setAttribute("info",2);
                    else {
            ...
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/deposerannoncephoto.jsp");
