 ...
 * @author pj
 */
public class InfosPersonnelles extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(membre.getId()==0)
                ...
                if(membre.getId()==0)
                    ...
                    if(request.getParameter("kermit")!=null) {
                        membre.getPostsInfosPersos(request);
                        membre.verifPostsInfosPersos(request);
                        membre.enregInfosPersos(request);
                    }
                    ListeDepartements listeDepartements=new ListeDepartements(membre.getIdRegion());
                    listeDepartements.initListe();
                    ListeCommunes listeCommunes=new ListeCommunes(membre.getIdRegion(), membre.getIdDepartement());
            ...
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/infospersonnelles.jsp");
