    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(request.getParameter("kermit")!=null) {
                membre.getPostsInsc(request);
                membre.verifPostsInsc(request);
                membre.enregInsc(request,response);
            }
            ...
            //out.println(listeCommunes.getErrorMsg());
            ...
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/inscription.jsp");
