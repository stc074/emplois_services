    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(request.getParameter("kermit")!=null) {
                membre.getPostsMdpOublie(request);
                membre.verifPostsMdpOublie(request);
                membre.sendNouveauMdp(request);
            }
            request.setAttribute("membre", membre);
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/mdpoublie.jsp");
