    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(membre.getId()==0)
                ...
                Annonces annonces=new Annonces(membre);
                if(request.getParameter("idTop")!=null) {
                    long idAnnonce=Long.parseLong(request.getParameter("idTop"));
                    ...
                    Annonce annonce=new Annonce(membre, idAnnonce);
                    annonce.effaceAnnonce();
                }
                annonces.initListeAnnonces();
