 ...
 * @author pj
 */
public class Messagerie1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(membre.getId()==0)
                ...
                Messagerie messagerie=new Messagerie(membre);
                messagerie.calculNbMsg();
                //out.println(messagerie.getErrorMsg());
                request.setAttribute("messagerie", messagerie);
            }
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/messagerie.jsp");
