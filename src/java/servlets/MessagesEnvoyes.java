        ...
        try {
            ...
            if(membre.getId()==0)
                ...
                if(request.getParameter("idDel")!=null) {
                    ...
                    message.effaceEnvoye(membre);
                }
                Messages messages=new Messages();
                messages.initListeEnvoyes(membre);
                request.setAttribute("messages", messages);
            }
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/messagesenvoyes.jsp");
