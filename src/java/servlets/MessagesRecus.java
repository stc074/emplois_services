        ...
        try {
            ...
            if(membre.getId()==0)
                ...
                if(request.getParameter("idDel")!=null) {
                    ...
                    message.effaceRecu(membre);
                }
                Messages messages=new Messages();
                messages.initListeRecus(membre);
                request.setAttribute("messages", messages);
            }
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/messagesrecus.jsp");
