           ...
           <p></p>
            <c:catch var="ex">
                ...
                <c:if test="${requestScope.info!=null}">
                    <c:choose>
                        <c:when test="${requestScope.info==1}">
                            <div class="cadre">
                                <div class="info">Vous devez être connecté pour pouvoir consulter vos message.</div>
                                <p></p>
                                <div>
                ...
                <c:if test="${requestScope.message!=null}">
                    ...
                    <c:choose>
                        <c:when test="${msg.idPrec!=0}">
                            <div class="cadre">
                                <div class="info"><c:out value="${msg.membreDestinataire.pseudo}"></c:out> vous avait envoyé un message, <c:out value="${msg.dateTxtPrec}"></c:out> :</div>
                                <p></p>
                                ...
                                <p></p>
                                <div class="cadre">
                                    <div class="info">Vous lui aviez répondu, <c:out value="${msg.dateTxt}"></c:out></div>
                        </c:when>
                        <c:when test="${msg.idPrec==0}">
                            <div class="cadre">
                                <div class="info">Vous avez écrit à <c:out value="${msg.membreExpediteur.pseudo}"></c:out>, <c:out value="${msg.dateTxt}"></c:out> :</div>
                        </c:when>
                    </c:choose>
                                ...
                                <div class="cadre">
                                    <div class="info">Pour re-répondre à <c:out value="${msg.membreDestinataire.pseudo}"></c:out>, utilisez le formulaire ci-dessous :</div>
                                </div>
                                <p></p>
                                <div id="form">
