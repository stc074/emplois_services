            ...
            <c:catch var="ex">
                ...
                <c:if test="${requestScope.messages!=null}">
                    ...
                    <c:choose>
                        ...
                        <c:when test="${msgs.nb>0}">
                            <div class="cadre">
                                <div class="info"><c:out value="${msgs.nb}"></c:out> message(s) reçu(s) dans votre boite :</div>
                            </div>
                            <p></p>
                            <c:forEach var="i" begin="0" end="${msgs.nb-1}" step="1">
                                <div class="cadre">
                                    <p>
                                        <span><a href="./message-recu-<c:out value="${msgs.ids[i]}"></c:out>.html" title="<c:out value="${msgs.titres[i]}"></c:out>"><c:out value="${msgs.titres[i]}"></c:out></a></span>
                                        ${msgs.comments[i]}
                                        <span>&nbsp;&nbsp;&rArr;<a href="./efface-recu-<c:out value="${msgs.ids[i]}"></c:out>.html" rel="nofollow" title="ÉFFACER CE MESSAGE">ÉFFACER CE MESSAGE</a></span>
                                    </p>
                                </div>
                                    <p></p>
                            </c:forEach>
